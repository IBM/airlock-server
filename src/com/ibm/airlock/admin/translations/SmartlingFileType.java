...
public enum SmartlingFileType
{
    ...
    private SmartlingFileType(final String mimeType, final boolean isTextFormat)
    {
    ...
    public static SmartlingFileType lookup(final String fileTypeString)
    {
        for (final SmartlingFileType fileType : SmartlingFileType.values())
        {
