...
public class AddAttributesToAnalyticsInExperiment {
	...
	public void addEntitlementToSeason1() throws IOException, JSONException, InterruptedException{
		...
		entitlementID1 = purchasesApi.addPurchaseItemToBranch(seasonID1, BranchesRestApi.MASTER, feature1, "ROOT", sessionToken);
	...
	@Test (dependsOnMethods="moveEntitlementToProduction", description="Move feature to development in season1")
	...
	public void addFeatureToBothSeasons() throws IOException, JSONException, InterruptedException{
		...
		newConfiguration.put("size", "small");
		jsonConfig.put("configuration", newConfiguration);
		String configID2 = purchasesApi.addPurchaseItemToBranch(seasonID2, BranchesRestApi.MASTER, jsonConfig.toString(), entitlementID2, sessionToken);
		...
		response = an.addAttributesToAnalytics(entitlementID2, BranchesRestApi.MASTER, attributes2.toString(), sessionToken);
