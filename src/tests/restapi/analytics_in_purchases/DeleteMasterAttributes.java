...
public class DeleteMasterAttributes {
	...
	public void addComponents() throws Exception{
		...
		entitlementID1 = purchasesApi.addPurchaseItem(seasonID, feature, "ROOT", sessionToken);
		...
		jsonConfig.put("configuration", newConfiguration);
		configID2 = purchasesApi.addPurchaseItem(seasonID, jsonConfig.toString(), entitlementID1, sessionToken);
	...
	public void deleteConfiguration() throws IOException, JSONException, InterruptedException{
		int code = purchasesApi.deletePurchaseItem(configID2, sessionToken);
