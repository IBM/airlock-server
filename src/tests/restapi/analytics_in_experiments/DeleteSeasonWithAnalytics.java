...
public class DeleteSeasonWithAnalytics {
	...
	*/
	...
	public void reportToAnalytics () throws IOException, JSONException, InterruptedException {
		...
		//add features to analytics in season1
		jsonF.put("name", "FeatureInSeason1");
		...
		jsonF.put("name", "FeatureInBranch1");
		String featureID2 = f.addFeatureToBranch(seasonID1, branchID1, jsonF.toString(), "ROOT", sessionToken);
		an.addFeatureToAnalytics(featureID2, branchID1, sessionToken);
		
		//add features to analytics in season2
		jsonF.put("name", "FeatureInSeason2");
		String featureID3 = f.addFeature(seasonID2, jsonF.toString(), "ROOT", sessionToken);
		an.addFeatureToAnalytics(featureID3, BranchesRestApi.MASTER, sessionToken);
		jsonF.put("name", "FeatureInBranch2");
		...
		Assert.assertTrue(analyticsFeaturesInExperiment(analyticsReponse)==4, "Incorrect number of features in experiment analytics");
		...
		err = validateFeaturesToAnalytics(experimentAnalytics, new String[]{"ns1.FeatureInBranch2", "ns1.FeatureInSeason1", "ns1.FeatureInBranch1", "ns1.FeatureInSeason2"});
		Assert.assertTrue(err == null, err);
	...
	public void deleteSeason () throws IOException, JSONException, InterruptedException {
		...
		Assert.assertTrue(err == null, err);		
		err = validateFeaturesToAnalytics(experimentAnalytics, new String[]{"ns1.FeatureInBranch2", "ns1.FeatureInSeason2"});
		Assert.assertTrue(err == null, err);
		...
		err = validateFeaturesToAnalytics(experimentAnalytics, new String[]{"ns1.FeatureInSeason1", "ns1.FeatureInBranch1"});
		Assert.assertTrue(err != null, "Deleted features found in experiment analytics");
