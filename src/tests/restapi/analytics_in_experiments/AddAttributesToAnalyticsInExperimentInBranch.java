...
public class AddAttributesToAnalyticsInExperimentInBranch {
	...
	public void addFeatureToSeason1() throws IOException, JSONException, InterruptedException{
		...
		configID1 = f.addFeatureToBranch(seasonID1, branchID1, jsonConfig.toString(), featureID1, sessionToken);
		...
		String response = an.addAttributesToAnalytics(featureID1, branchID1, attributes.toString(), sessionToken);
	...
	public void addFeatureToBothSeasons() throws IOException, JSONException, InterruptedException{
		...
		newConfiguration.put("size", "small");
		jsonConfig.put("configuration", newConfiguration);
		String configID2 = f.addFeatureToBranch(seasonID2, branchID2, jsonConfig.toString(), featureID2, sessionToken);
		...
		response = an.addAttributesToAnalytics(featureID2, branchID2, attributes2.toString(), sessionToken);
