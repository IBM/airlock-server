...
public class AddAttributesToAnalyticsInDevelopmentExperiment {
	...
	public void addFeatures() throws IOException, JSONException, InterruptedException{
		...
		configID2 = f.addFeatureToBranch(seasonID1, BranchesRestApi.MASTER, jsonConfig.toString(), featureID2, sessionToken);
		...
		response = an.addAttributesToAnalytics(featureID2, branchID1, attributes.toString(), sessionToken);
		Assert.assertFalse(response.contains("error"), "Attributes were not added to analytics" + response);
		...
		String configID3 = f.addFeatureToBranch(seasonID2, BranchesRestApi.MASTER, jsonConfig.toString(), featureID3, sessionToken);
		...
		String configID4 = f.addFeatureToBranch(seasonID2, branchID2, jsonConfig.toString(), featureID4, sessionToken);
