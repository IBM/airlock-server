...
public class PurchaseItemsInBranchUponSeasonCreation {
	 ...
	 *								CR3   CR4                      
	 */
	@Test (description ="add branch and add purcahses and feature to branch")
	public void addComponents () throws Exception {
		...
		iapMixID1 = purchasesApi.addPurchaseItemToBranch(seasonID1, branchID1, iapMix, "ROOT", sessionToken);
		...
		inAppPurchaseID1 = purchasesApi.addPurchaseItemToBranch(seasonID1, branchID1, inAppPurJson.toString(), iapMixID1, sessionToken);
		...
		inAppPurchaseID2 = purchasesApi.addPurchaseItemToBranch(seasonID1, branchID1, inAppPurJson.toString(), iapMixID1, sessionToken);
		...
		purchaseOptID1 = purchasesApi.addPurchaseItemToBranch(seasonID1, branchID1, purOptJson.toString(), inAppPurchaseID1, sessionToken);
		...
		purchaseOptID2 = purchasesApi.addPurchaseItemToBranch(seasonID1, branchID1, purOptJson.toString(), inAppPurchaseID1, sessionToken);
		...
		configID1 = purchasesApi.addPurchaseItemToBranch(seasonID1, branchID1, configJson.toString(), inAppPurchaseID1, sessionToken);
		...
		configID2 = purchasesApi.addPurchaseItemToBranch(seasonID1, branchID1, configJson.toString(), purchaseOptID1, sessionToken);
		...
		poMixID1 = purchasesApi.addPurchaseItemToBranch(seasonID1, branchID1, purchaseOptionsMix, inAppPurchaseID2, sessionToken);
		...
		purchaseOptID3 = purchasesApi.addPurchaseItemToBranch(seasonID1, branchID1, purOptJson.toString(), poMixID1, sessionToken);
		...
		purchaseOptID4 = purchasesApi.addPurchaseItemToBranch(seasonID1, branchID1, purOptJson.toString(), poMixID1, sessionToken);
		...
		configMixID1 = purchasesApi.addPurchaseItemToBranch(seasonID1, branchID1, configurationMix, purchaseOptID3, sessionToken);
		...
		configID3 = purchasesApi.addPurchaseItemToBranch(seasonID1, branchID1, configJson.toString(), configMixID1, sessionToken);
		...
		configID4 = purchasesApi.addPurchaseItemToBranch(seasonID1, branchID1, configJson.toString(), configMixID1, sessionToken);
	...
	public void checkNewIds () throws Exception {
		...
		Assert.assertTrue(iapMixObj.getString("branchStatus").equals("NEW"), "wrong branch status");
		...
		Assert.assertTrue(inAppPurcahseObj1.getString("branchStatus").equals("NEW"), "wrong branch status");
		...
		Assert.assertTrue(inAppPurcahseObj2.getString("branchStatus").equals("NEW"), "wrong branch status");
		...
		Assert.assertTrue(configObj1.getString("branchStatus").equals("NEW"), "wrong branch status");
		...
		Assert.assertTrue(purOptObj1.getString("branchStatus").equals("NEW"), "wrong branch status");
		...
		Assert.assertTrue(purOptObj2.getString("branchStatus").equals("NEW"), "wrong branch status");
		...
		Assert.assertTrue(configObj2.getString("branchStatus").equals("NEW"), "wrong branch status");
		...
		Assert.assertTrue(purOptMixObj.getString("branchStatus").equals("NEW"), "wrong branch status");
		...
		Assert.assertTrue(purOptObj3.getString("branchStatus").equals("NEW"), "wrong branch status");
		...
		Assert.assertTrue(purOptObj4.getString("branchStatus").equals("NEW"), "wrong branch status");
		...
		Assert.assertTrue(configMixObj.getString("branchStatus").equals("NEW"), "wrong branch status");
		...
		Assert.assertTrue(configObj3.getString("branchStatus").equals("NEW"), "wrong branch status");
		...
		Assert.assertTrue(configObj4.getString("branchStatus").equals("NEW"), "wrong branch status");
