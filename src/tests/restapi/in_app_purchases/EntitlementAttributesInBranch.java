...
public class EntitlementAttributesInBranch {
	...
	public void addComponents() throws JSONException, IOException, InterruptedException{
		...
		entitlementID = purchasesApi.addPurchaseItemToBranch(seasonID, branchID, json.toString(), "ROOT", sessionToken);
		...
		String configID1 = purchasesApi.addPurchaseItemToBranch(seasonID, branchID, jsonConfig.toString(), entitlementID, sessionToken);
		...
		String configID2 = purchasesApi.addPurchaseItemToBranch(seasonID, branchID, jsonConfig2.toString(), entitlementID, sessionToken);
