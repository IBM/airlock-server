...
public class UpdatePurchasesTreeInMaster {
	...
	public void addComponents () throws IOException, JSONException, InterruptedException {
		...
		purchaseOptionsID1 = purchasesApi.addPurchaseItem(seasonID, purOptJson.toString(), entitlementID1, sessionToken);
		...
		mixConfigID = purchasesApi.addPurchaseItem(seasonID, configurationMix, purchaseOptionsID1, sessionToken);
		...
		purchaseOptionsID3 = purchasesApi.addPurchaseItem(seasonID, purOptJson.toString(), entitlementID2, sessionToken);
		Assert.assertFalse(purchaseOptionsID1.contains("error"), "purchaseOptions was not added to the season: " + purchaseOptionsID1);
		
		purOptJson.put("name", "PO4");
		purchaseOptionsID4 = purchasesApi.addPurchaseItem(seasonID, purOptJson.toString(), entitlementID2, sessionToken);
		Assert.assertFalse(purchaseOptionsID1.contains("error"), "purchaseOptions was not added to the season: " + purchaseOptionsID1);
		
		JSONArray purchases = purchasesApi.getPurchasesBySeason(seasonID, sessionToken);
	...
	public void deletepPurchaseOptionsDuringUpdate() throws Exception{
		...
		String response = purchasesApi.updatePurchaseItem(seasonID, entitlementID1, e1Obj.toString(), sessionToken);
	...
	public void deletepEntitlementDuringUpdate() throws Exception{
		String purcahsesRootId = purchasesApi.getBranchRootId(seasonID, "MASTER", sessionToken);
		String root = purchasesApi.getPurchaseItem(purcahsesRootId, sessionToken);
		JSONObject rootObj = new JSONObject(root);
		rootObj.put("entitlements", new JSONArray());
		
		String response = purchasesApi.updatePurchaseItem(seasonID, purcahsesRootId, rootObj.toString(), sessionToken);
	...
	public void updatePurcahseOptionsParent() throws Exception{
		String e2 = purchasesApi.getPurchaseItem(entitlementID2, sessionToken);
		JSONObject e2Obj = new JSONObject(e2);
		JSONArray purchaseOptionsArr = e2Obj.getJSONArray("purchaseOptions");
		
		String op1 = purchasesApi.getPurchaseItem(purchaseOptionsID1, sessionToken);
		...
		String response = purchasesApi.updatePurchaseItem(seasonID, entitlementID2, e2Obj.toString(), sessionToken);
