...
public class PurchaseItemsInMasterAndBranchUponSeasonCreation {
	 ...
	 *								CR3   CR4                      
	 */
	@Test (description ="add branch and add purcahses to master and add feature and bundle to branch")
	public void addComponents () throws Exception {
		...
		iapMixID1 = purchasesApi.addPurchaseItemToBranch(seasonID1, "MASTER", iapMix, "ROOT", sessionToken);
		...
		inAppPurchaseID1 = purchasesApi.addPurchaseItemToBranch(seasonID1, "MASTER", inAppPurJson.toString(), iapMixID1, sessionToken);
		...
		inAppPurchaseID2 = purchasesApi.addPurchaseItemToBranch(seasonID1, "MASTER", inAppPurJson.toString(), iapMixID1, sessionToken);
		...
		purchaseOptID1 = purchasesApi.addPurchaseItemToBranch(seasonID1, "MASTER", purOptJson.toString(), inAppPurchaseID1, sessionToken);
		...
		purchaseOptID2 = purchasesApi.addPurchaseItemToBranch(seasonID1, "MASTER", purOptJson.toString(), inAppPurchaseID1, sessionToken);
		...
		configID1 = purchasesApi.addPurchaseItemToBranch(seasonID1, "MASTER", configJson.toString(), inAppPurchaseID1, sessionToken);
		...
		configID2 = purchasesApi.addPurchaseItemToBranch(seasonID1, "MASTER", configJson.toString(), purchaseOptID1, sessionToken);
		...
		poMixID1 = purchasesApi.addPurchaseItemToBranch(seasonID1, "MASTER", purchaseOptionsMix, inAppPurchaseID2, sessionToken);
		...
		purchaseOptID3 = purchasesApi.addPurchaseItemToBranch(seasonID1, "MASTER", purOptJson.toString(), poMixID1, sessionToken);
		...
		purchaseOptID4 = purchasesApi.addPurchaseItemToBranch(seasonID1, "MASTER", purOptJson.toString(), poMixID1, sessionToken);
		...
		configMixID1 = purchasesApi.addPurchaseItemToBranch(seasonID1, "MASTER", configurationMix, purchaseOptID3, sessionToken);
		...
		configID3 = purchasesApi.addPurchaseItemToBranch(seasonID1, "MASTER", configJson.toString(), configMixID1, sessionToken);
		...
		configID4 = purchasesApi.addPurchaseItemToBranch(seasonID1, "MASTER", configJson.toString(), configMixID1, sessionToken);
		...
		featureID1 = f.addFeatureToBranch(seasonID1, branchID1, jsonF.toString(), "ROOT", sessionToken);
		...
		bundleID = purchasesApi.addPurchaseItemToBranch(seasonID1, branchID1, inAppPurJson.toString(), "ROOT", sessionToken);
	...
	public void checkNewIds () throws Exception {
		...
		Assert.assertTrue(jsonBranch.getJSONArray("branches").size()==2, "wrong number of branches in new season");
		String branchInNewSeasonId = jsonBranch.getJSONArray("branches").getJSONObject(1).getString("uniqueId");
		
		JSONArray purchaseItems = purchasesApi.getPurchasesBySeasonFromBranch(seasonID2, branchInNewSeasonId, sessionToken);
		...
		Assert.assertTrue(iapMixObj.getString("branchStatus").equals("NONE"), "wrong branch status");
		...
		Assert.assertTrue(bundleObj.getString("branchStatus").equals("NEW"), "wrong branch status");
		...
		Assert.assertTrue(inAppPurcahseObj1.getString("branchStatus").equals("NONE"), "wrong branch status");
		...
		Assert.assertTrue(inAppPurcahseObj2.getString("branchStatus").equals("NONE"), "wrong branch status");
		...
		Assert.assertTrue(configObj1.getString("branchStatus").equals("NONE"), "wrong branch status");
		...
		Assert.assertTrue(purOptObj1.getString("branchStatus").equals("NONE"), "wrong branch status");
		...
		Assert.assertTrue(purOptObj2.getString("branchStatus").equals("NONE"), "wrong branch status");
		...
		Assert.assertTrue(configObj2.getString("branchStatus").equals("NONE"), "wrong branch status");
		...
		Assert.assertTrue(purOptMixObj.getString("branchStatus").equals("NONE"), "wrong branch status");
		Assert.assertFalse(purOptMixObj.getString("uniqueId").equals(poMixID1), "wrong purchase options mix id");
		...
		Assert.assertTrue(purOptObj3.getString("branchStatus").equals("NONE"), "wrong branch status");
		...
		Assert.assertTrue(purOptObj4.getString("branchStatus").equals("NONE"), "wrong branch status");
		...
		Assert.assertTrue(configMixObj.getString("branchStatus").equals("NONE"), "wrong branch status");
		...
		Assert.assertTrue(configObj3.getString("branchStatus").equals("NONE"), "wrong branch status");
		...
		Assert.assertTrue(configObj4.getString("branchStatus").equals("NONE"), "wrong branch status");
		...
		JSONArray featureItems = f.getFeaturesBySeasonFromBranch(seasonID2, branchInNewSeasonId, sessionToken);
	...
	private String addBranch(String branchName) throws JSONException, IOException{
		...
		return br.createBranch(seasonID1, branchJson.toString(), BranchesRestApi.MASTER, sessionToken);
	}
	@AfterTest
	private void reset(){
