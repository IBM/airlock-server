...
public class AddAndDeleteToMutualExclusive2 {
	...
	/*
	 * This test validates that 1 feature can be added to a mutual exclusive group while the other is simultaneous  deleted from it
	 */
	...
	public void init(String url, String analyticsUrl, String translationsUrl, String configPath, String sToken, String userName, String userPassword, String appName, String productsToDeleteFile) throws Exception{
	   ...
	   //add 1 child to featureID
	   @Test(threadPoolSize = 2, invocationCount = 2, timeOut = 10000, description = "Simultaneously add one feature to the mutually exclusive group and delete another from it")
	   ...
	   @Test (dependsOnMethods = "addFeature", description = "Validate mutually exclusive group")
