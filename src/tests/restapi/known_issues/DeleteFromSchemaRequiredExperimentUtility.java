...
//delete from schema a required field used inside experiment utility
public class DeleteFromSchemaRequiredExperimentUtility
{
	...
	public void initExperiment() throws Exception
	{
		...
		String experimentID = config.addExperiment("1.1.1", "3.0", "experiments/experiment1.txt", "hasDateTime()", false);
