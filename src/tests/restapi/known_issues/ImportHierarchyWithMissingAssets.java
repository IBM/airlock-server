...
public class ImportHierarchyWithMissingAssets {
	...
	public void simulateCopyFeatureToRoot() throws IOException, JSONException{
		...
		//TODO: uncomment when response is changed to json object
		/*JSONObject json = new JSONObject(response);
		Assert.assertTrue(json.getJSONArray("missingUtilities").size() == 2, "Incorrect number of missingUtilities");
		Assert.assertTrue(json.getJSONArray("missingFields").size() == 2, "Incorrect number of missingFields");
		*/
	}
