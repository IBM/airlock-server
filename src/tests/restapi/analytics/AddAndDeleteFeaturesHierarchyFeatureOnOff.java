...
public class AddAndDeleteFeaturesHierarchyFeatureOnOff {
	...
	/*Test flow:
	- create feature with sub features, add sub feature to analytics, delete parent feature
	- create feature with hierarchy of sub features, add lower feature to analytics, delete parent feature
	 * 
	 */
	

	@Test (description="Add  feature with sub-feature. Add sub-feature to featuresAndConfigurationsForAnalytics")
	...
	@Test (dependsOnMethods="addComponents1", description="Delete parent feature and validate analytics")
	public void deleteParent1() throws IOException, JSONException, InterruptedException{
	...
	@Test (dependsOnMethods="deleteParent1", description="Add  feature with hierarchy of sub-features. Add the lowest sub-feature to featuresAndConfigurationsForAnalytics")
	public void addComponents2() throws IOException, JSONException, InterruptedException{
		...
		featureID3 = f.addFeatureToBranch(seasonID, branchID, feature3, featureID1, sessionToken);
	...
	public void deleteParent2() throws IOException, JSONException, InterruptedException{
		String dateFormat = an.setDateFormat();
