...
public class CopyEntitlementWithNewStringsAdditionalLocales {
	...
	/*
	 * copy entitlement with single string in configuration rule, no conflict, but there is additional locale and string status changes
	 */
	...
	@Test (dependsOnMethods="addLocale", description = "Copy entitlement to season2 without conflict, but with additional locale - status should change")
	public void copyEntitlementDifferentSeason2() throws Exception{
