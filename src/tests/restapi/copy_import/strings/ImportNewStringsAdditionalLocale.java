...
public class ImportNewStringsAdditionalLocale {
	...
	public void importStringToDifferentSeason() throws Exception{
		...
		response = stringsApi.importStrings(content, seasonID2, "ACT", false, sessionToken);
