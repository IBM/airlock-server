...
public class CopyComplexStructureDifferentProduct {
	...
	public void copyEntitlements() throws IOException, JSONException{
		...
		String oldFeature = purchasesApi.getPurchaseItemFromBranch(entitlementID1, srcBranchID, sessionToken);
