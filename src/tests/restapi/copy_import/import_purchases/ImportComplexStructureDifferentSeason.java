...
public class ImportComplexStructureDifferentSeason {
	...
	public void importPurchaseOptionsMtx() throws IOException, JSONException{
		...
		String response = f.importFeatureToBranch(poMixToImport, targetEntitlementID, "ACT", null, "suffix3", true, sessionToken, destBranchID);
