...
public class CopyOrderingRuleDifferentProduct {
	...
	public void copy1() throws JSONException, IOException{
		...
		String response = f.copyItemBetweenBranches(parentID, rootId, "ACT", null, "suffix1", sessionToken, srcBranchID, destBranchID);
	...
	public void copy3() throws JSONException, IOException{
		...
		String rootId = f.getBranchRootId(seasonID2, destBranchID, sessionToken);
		String response = f.copyItemBetweenBranches(mtxID, rootId, "ACT", null, "suffix1", sessionToken, srcBranchID, destBranchID);
		Assert.assertFalse(response.contains("error"), "Can't copy feature: " + response);
