...
public class ImportOrderingRuleDifferentProduct {
	...
	public void init(String url, String analyticsUrl, String translationsUrl, String configPath, String sToken, String userName, String userPassword, String appName, String productsToDeleteFile, Boolean runOnMaster) throws Exception{
		...
		if (runOnMaster) {
			...
			destBranchID = jsonBranch.getJSONArray("branches").getJSONObject(0).getString("uniqueId");
		}
	...
	public void copy2() throws JSONException, IOException{
		...
		JSONObject jsonResp = new JSONObject(response);
		String newParentID = jsonResp.getString("newSubTreeId");
		JSONObject newTree = new JSONObject(f.getFeature(newParentID, sessionToken));
