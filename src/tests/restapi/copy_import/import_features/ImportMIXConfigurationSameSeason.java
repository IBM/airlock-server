...
public class ImportMIXConfigurationSameSeason {
	...
	@Test (description="Import mix configuration under another feature in the same season.")
	...
	@Test (dependsOnMethods="importConfigurationUnderItself", description="Import mix configuration under configuration in the same feature in the same season.")
