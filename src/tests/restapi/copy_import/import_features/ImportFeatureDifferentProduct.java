...
public class ImportFeatureDifferentProduct {
	...
	public void importSingleFeatureUnderFeature() throws IOException, JSONException{
		...
		response = f.importFeatureToBranch(featureToImport, featureID2, "ACT", null, "suffix1", false, sessionToken, destBranchID);
	...
	@Test (dependsOnMethods="importSingleFeatureUnderFeature", description="Import mix feature under mix feature in the new products. ")
	...
	@Test (dependsOnMethods="importSingleFeatureUnderMixFeature", description="Import mix feature under root in the new products.")
	...
	@Test (dependsOnMethods="importSingleFeatureUnderRoot", description="Import mix feature under configuration in the new product. ")
	...
	@Test (dependsOnMethods="importSingleFeatureUnderConfiguration", description="Import mix feature under mix configuration in the new products.")
