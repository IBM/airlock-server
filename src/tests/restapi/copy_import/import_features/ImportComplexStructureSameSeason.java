...
public class ImportComplexStructureSameSeason {
	...
	@Test (dependsOnMethods="addComponents", description="Import the whole structure under target feature")
	public void importFeature() throws IOException, JSONException{
		...
		String response = f.importFeatureToBranch(featureToImport, targetFeatureID, "ACT", null, "suffix1", true, sessionToken, srcBranchID);
