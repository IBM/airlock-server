...
public class DeleteInternalUserGroupInUseByFeature {
	...
	@Test (dependsOnMethods = "addFeature", description = "Delete usergroup in use by feature")
	public void deleteUserGroups() throws Exception{
		...
		String res = ug.setUserGroups(productID, json.toString(), sessionToken);
		Assert.assertTrue(res.contains("cannot be deleted") && res.contains("ns1.Feature1"), "Removed usergroup in use");
	}
