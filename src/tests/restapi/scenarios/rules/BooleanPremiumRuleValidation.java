...
public class BooleanPremiumRuleValidation {
	...
	@Test (dependsOnMethods = "addComponents", description = "Add single line comment in rule")
	...
	@Test (dependsOnMethods = "singleLineCommentInRule",  description = "Add single line comment and boolean expression in rule ")	
	...
	@Test (dependsOnMethods = "singleLineCommentAndExpressionInRule", description = "Add multi line comment in rule")
	...
	@Test (dependsOnMethods = "ruleWithoutBoolean1", description = "Add non-boolean expression in rule")
	...
	@Test (dependsOnMethods = "ruleWithoutBoolean2",  description = "Add boolean expression in rule")
