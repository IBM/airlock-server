...
public class UpdateParentToRoot {
	...
	public void init(String url, String analyticsUrl, String translationsUrl, String configPath, String sToken, String userName, String userPassword, String appName, String productsToDeleteFile) throws Exception{
		...
		featureID2 = baseUtils.createFeature(seasonID);	//parent feature2
	...
	/*
	 * This test validates that a feature can be moved to a different parent feature
	 */
	@Test (description = "This test validates that a feature can be moved to a different parent feature")
	...
	/*
	 * This test validates that a feature can be moved from a parent feature to the ROOT
	 */

	@Test (dependsOnMethods = "validateParents", description = "This test validates that a feature can be moved from a parent feature to the ROOT")
	...
	@Test (dependsOnMethods = "moveToRoot")
