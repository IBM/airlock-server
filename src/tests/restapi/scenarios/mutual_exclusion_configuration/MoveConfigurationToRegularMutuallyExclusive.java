...
public class MoveConfigurationToRegularMutuallyExclusive {
	...
	@Test (dependsOnMethods="createMutuallyExclusiveWithFeature", description = "Move configuration rule from its mi group to MI group of regular features")
	public void moveConfigurationToMI() throws JSONException{
		try {
			
			String configuration = f.getFeature(childID1, sessionToken);
