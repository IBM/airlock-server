...
public class MIIncreaseMaxFeatureOn {
	...
	public void addFeatureInProductionToMIXBeforeIncrease () throws IOException, JSONException{
	...
	@Test (dependsOnMethods="addFeatureInProductionToMIXBeforeIncrease", description = "Increase maxFeatureOn to 3") 
	...
	@Test (dependsOnMethods="increaseMaxFeaturesOn", description = "Add third feature in Production with defaultSystemIsDown=true")
	public void addFeatureInProductionToMIXAfterIncrease () throws IOException, JSONException{
		String child3 = createFeature("feature3.txt");
		String response = f.addFeature(seasonID, child3, parentID, sessionToken);
