...
public class DisableExperimentInProduction {
	...
	public void addComponents () throws IOException, JSONException, InterruptedException {
		...
		Assert.assertTrue(getExperiments(responseProd.message)==0, "Disabled experiment is written in runtime");
		Assert.assertTrue(getBranches(responseProd.message)==0, "Disabled branch is written in runtime");
	...
	public void enableExperiment () throws Exception {
		...
		Assert.assertTrue(getExperiments(responseProd.message)==1, "Enabled experiment is not written in runtime");
		Assert.assertTrue(getBranches(responseProd.message)==1, "Enabled branch is not written in runtime");
	...
	public void disableVariant () throws Exception {
		...
		Assert.assertTrue(responseProd.code ==200, "Runtime production feature file was changed");
		Assert.assertTrue(getExperiments(responseProd.message)==1, "Enabled experiment is not written in runtime");
		Assert.assertTrue(getVariants(responseProd.message)==0, "Disabled variant is  written in runtime");
		Assert.assertTrue(getBranches(responseProd.message)==0, "Disabled branch is written in runtime");
	...
	public void enableVariant () throws Exception {
		...
		Assert.assertTrue(responseProd.code ==200, "Runtime production feature file was changed");
		Assert.assertTrue(getExperiments(responseProd.message)==1, "Enabled experiment is not written in runtime");
		Assert.assertTrue(getVariants(responseProd.message)==1, "Enabled variant is not written in runtime");
		Assert.assertTrue(getBranches(responseProd.message)==1, "Enabled branch is not written in runtime");
