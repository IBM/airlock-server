...
public class DuplicateBranch7 {
    ...
    public void assertBranchDuplication (Boolean newIds, String season) throws Exception {
        ...
        assertItemDuplicated(feature,"CHECKED_OUT",featureID1,newIds,1,new String[]{"mx."+mxcr1NewId},
        ...
        JSONObject mx2 = mx1.getJSONArray("features").getJSONObject(1);
        String mx2NewId = mx2.getString("uniqueId");
        assertItemDuplicated(mx1,"CHECKED_OUT",mixID1,newIds,0,new String[]{},
                0,2,new String[]{"ns1.F2","mx."+mx2NewId}, 2 ,null);
        JSONObject feature2 = mx2.getJSONArray("features").getJSONObject(0);
        assertItemDuplicated(feature2,"CHECKED_OUT",featureID3,newIds,0,new String[]{},
                0,0,new String[]{}, 0 ,null);

        assertItemDuplicated(mx2,"CHECKED_OUT",mixID2,newIds,0,new String[]{},
                0,2,new String[]{"ns1.F3","ns1.F4"}, 2 ,null);

        JSONObject feature3 = mx2.getJSONArray("features").getJSONObject(0);
        assertItemDuplicated(feature3,"CHECKED_OUT",featureID3,newIds,0,new String[]{},
                0,0,new String[]{}, 0 ,null);

        JSONObject feature4 = mx2.getJSONArray("features").getJSONObject(1);
        assertItemDuplicated(feature4,"CHECKED_OUT",featureID4,newIds,0,new String[]{},
                0,0,new String[]{}, 0 ,null);
        ...
        mx2 = mx1.getJSONArray("features").getJSONObject(1);
        mx2NewId = mx2.getString("uniqueId");
        assertItemDuplicated(mx1,"CHECKED_OUT",mixID1,newIds,0,new String[]{},
                0,2,new String[]{"ns1.F2","mx."+mx2NewId}, 2 ,null);
        feature2 = mx2.getJSONArray("features").getJSONObject(0);
        assertItemDuplicated(feature2,"CHECKED_OUT",featureID3,newIds,0,new String[]{},
                0,0,new String[]{}, 0 ,null);
        ...
        feature3 = mx2.getJSONArray("features").getJSONObject(0);
        assertItemDuplicated(feature3,"CHECKED_OUT",featureID3,newIds,0,new String[]{},
                0,0,new String[]{}, 0 ,null);

        feature4 = mx2.getJSONArray("features").getJSONObject(1);
        assertItemDuplicated(feature4,"CHECKED_OUT",featureID4,newIds,0,new String[]{},
                0,0,new String[]{}, 0 ,null);
