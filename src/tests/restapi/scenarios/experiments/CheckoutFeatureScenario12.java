...
public class CheckoutFeatureScenario12 {
	...
	@Test (dependsOnMethods="scenario12", description="Checkout F8")
	public void checkout() throws JSONException, Exception{				

		String res = br.checkoutFeature(branchID, featureID8, sessionToken); //checks out the whole tree except for F10
