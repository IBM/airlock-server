...
public class AddConfigurationRuleToFeature {
	...
	@Test (dependsOnMethods="createConfigurationRule", description = "Get the feature and validate that is has configuration rule as a child")
	public void validateConfigurationRule() throws IOException, JSONException{
		...
		JSONObject configRule = children.getJSONObject(0);
		Assert.assertTrue(configRule.getString("uniqueId").equals(configRuleID), "Incorrect configuration rule in feature");
	}
