...
public class ConfigurationRuleStagesMTXAdvanced {
...
/*
F -> CR1->CRMTX->(CR2 + CR3)
	Create dev->dev->prod+dev, update to prod->dev->prod+dev
	Create dev->prod->prod+dev, update to dev->dev->prod+dev
	Create prod->dev->prod+dev, udpate to dev->dev->prod+dev, udpate to dev->prod->prod+dev
	Create dev->dev->dev+dev, update to dev->prod->prod+prod (as a tree)
	Create dev->dev->dev+dev, update to dev->dev->prod+dev, update to prod->dev->prod+dev
	Create prod->dev->prod+prod, update to dev->prod->prod+prod
	Create prod->prod->prod+prod, update to dev->prod->prod+prod
	Create prod->prod->dev+dev, update to dev->dev->prod+prod (as a tree)
	Create prod->prod->prod+prod, update to prod->dev->prod+prod
 */

	@Test (description = "Create dev->dev->prod+dev, update to prod->dev->prod+dev")
	public void test1() throws JSONException, IOException, InterruptedException{
			...
			String mtxID = f.addFeature(seasonID, configMTX.toString(), configID1, sessionToken);
			...
			jsonCR.put("name", RandomStringUtils.randomAlphabetic(5));
			String configID3 = f.addFeature(seasonID, jsonCR.toString(), mtxID, sessionToken);
			Assert.assertFalse(configID3.contains("error"), "Feature was not created: " + configID3);
	...
	@Test (description = "Create dev->prod->prod+dev, update to dev->dev->prod+dev")
	public void test2() throws JSONException, IOException, InterruptedException{
			...
			String config1Feature = f.getFeature(configID1, sessionToken);
			JSONObject jsonCR1 = new JSONObject(config1Feature);
			jsonCR1.put("stage", "DEVELOPMENT");
			String response = f.updateFeature(seasonID, configID1, jsonCR1.toString(), sessionToken);
			Assert.assertFalse(response.contains("error"), "feature was not updated: " + response);
	...
	@Test (description = "Create prod->dev->prod+dev, udpate to dev->dev->prod+dev, udpate to dev->prod->prod+dev")
	public void test3() throws JSONException, IOException, InterruptedException{
			...
			response = f.updateFeature(seasonID, configID1, jsonCR1.toString(), sessionToken);
			Assert.assertFalse(response.contains("error"), "feature was not updated: " + response);
	...
	@Test (description = "Create dev->dev->dev+dev, update to dev->prod->prod+prod (as a tree)")
	public void test4() throws JSONException, IOException, InterruptedException{
			...
			JSONObject jsonCR1 = new JSONObject(config1Feature);
			jsonCR1.put("stage", "PRODUCTION");
			jsonCR1.getJSONArray("configurationRules").getJSONObject(0).getJSONArray("configurationRules").getJSONObject(0).put("stage", "PRODUCTION");
			jsonCR1.getJSONArray("configurationRules").getJSONObject(0).getJSONArray("configurationRules").getJSONObject(1).put("stage", "PRODUCTION");
			String response = f.updateFeature(seasonID, configID1, jsonCR1.toString(), sessionToken);
			Assert.assertFalse(response.contains("error"), "feature was not updated: " + response);
	...
	@Test (description = "Create dev->dev->dev+dev, update to dev->dev->prod+dev, update to prod->dev->prod+dev")
	public void test5() throws JSONException, IOException, InterruptedException{
			...
			String config2Feature = f.getFeature(configID2, sessionToken);
			JSONObject jsonCR2 = new JSONObject(config2Feature);
			jsonCR2.put("stage", "PRODUCTION");
			String response = f.updateFeature(seasonID, configID2, jsonCR2.toString(), sessionToken);
			Assert.assertFalse(response.contains("error"), "feature was not updated: " + response);
	...
	@Test (description = "Create prod->dev->prod+prod, update to dev->prod->prod+prod")
	public void test6() throws JSONException, IOException, InterruptedException{
			...
			JSONObject jsonParent = new JSONObject(parentFeature);
			jsonParent.put("stage", "DEVELOPMENT");
			jsonParent.getJSONArray("configurationRules").getJSONObject(0).put("stage", "PRODUCTION");
			String response = f.updateFeature(seasonID, parentID, jsonParent.toString(), sessionToken);
			Assert.assertFalse(response.contains("error"), "feature was not updated: " + response);
	...
	@Test (description = "Create prod->prod->prod+prod, update to dev->prod->prod+prod")
	...
	@Test (description = "Create prod->prod->dev+dev, update to dev->dev->prod+prod (as a tree)")
	public void test8() throws JSONException, IOException, InterruptedException{
			...
			jsonParent.getJSONArray("configurationRules").getJSONObject(0).getJSONArray("configurationRules").getJSONObject(0).getJSONArray("configurationRules").getJSONObject(0).put("stage", "PRODUCTION");
			jsonParent.getJSONArray("configurationRules").getJSONObject(0).getJSONArray("configurationRules").getJSONObject(0).getJSONArray("configurationRules").getJSONObject(1).put("stage", "PRODUCTION");
			String response = f.updateFeature(seasonID, parentID, jsonParent.toString(), sessionToken);
			Assert.assertFalse(response.contains("error"), "feature was not updated: " + response);
	...
	@Test (description = "Create prod->prod->prod+prod, update to prod->dev->prod+prod")
	public void test9() throws JSONException, IOException, InterruptedException{
			...
			String configFeature = f.getFeature(configID1, sessionToken);
			JSONObject jsonCR1 = new JSONObject(configFeature);
			jsonCR1.put("stage", "DEVELOPMENT");
			String response = f.updateFeature(seasonID, configID1, jsonCR1.toString(), sessionToken);
			Assert.assertFalse(response.contains("error"), "feature was not updated: " + response);
