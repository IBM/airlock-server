...
public class ConfigurationRuleStagesAdvanced {
...
/*
 * F -> CR1 -> CR2
	Create dev->dev->prod, update to prod->dev->prod, update to prod->prod->prod
	Create dev->prod->prod, update to prod->prod->prod
	Create prod->dev->prod
	Create dev->dev->dev, update to dev->prod->dev
	Create dev->dev->dev, update to dev->dev->prod
	Create dev->dev->dev, update to dev->prod->prod (as a tree)
	Create prod->dev->prod, update to dev->prod->prod
	Create prod->prod->prod, update to dev->prod->prod
	Create prod->prod->dev, update to dev->dev->prod (as a tree)
	Create prod->prod->prod, update to prod->dev->prod
 */

	@Test (description = "Create dev->dev->prod, update to prod->dev->prod, update to prod->prod->prod")
	public void test1() throws JSONException, IOException, InterruptedException{
			...
			JSONObject jsonConfig = new JSONObject(configFeature);
			jsonConfig.put("stage", "PRODUCTION");
			response = f.updateFeature(seasonID, configID1, jsonConfig.toString(), sessionToken);
			Assert.assertFalse(response.contains("error"), "feature was not updated: " + response);

			f.setSleep();
			responseDev = RuntimeDateUtilities.getDevelopmentFileDateModification(m_url, productID, seasonID, dateFormat, sessionToken);
			Assert.assertTrue(responseDev.code ==200, "Runtime development feature file was not updated");	
			Assert.assertTrue(validateProductionFeatures(responseDev.message, parentID)==3, "Incorrect number of development features");
			responseProd = RuntimeDateUtilities.getProductionFileDateModification(m_url, productID, seasonID, dateFormat, sessionToken);
			Assert.assertTrue(responseProd.code ==200, "Runtime production feature file was not changed");
	...
	@Test (description = "Create dev->prod->prod, update to prod->prod->prod")
	...
	@Test (description = "Create prod->dev->prod")
	...
	@Test (description = "Create dev->dev->dev, update to dev->prod->dev")
	public void test5() throws JSONException, IOException, InterruptedException{
			...
			String childFeature = f.getFeature(configID1, sessionToken);
			JSONObject jsonConfig = new JSONObject(childFeature);
			jsonConfig.put("stage", "PRODUCTION");
			String response = f.updateFeature(seasonID, configID1, jsonConfig.toString(), sessionToken);
			Assert.assertFalse(response.contains("error"), "feature was not updated: " + response);
	...
	@Test (description = "Create dev->dev->dev, update to dev->dev->prod")
	...
	@Test (description = "Create dev->dev->dev, update to dev->prod->prod (as a tree)")
	public void test7() throws JSONException, IOException, InterruptedException{
			...
			jsonParent.getJSONArray("configurationRules").getJSONObject(0).getJSONArray("configurationRules").getJSONObject(0).put("stage", "PRODUCTION");
			String response = f.updateFeature(seasonID, parentID, jsonParent.toString(), sessionToken);
			Assert.assertFalse(response.contains("error"), "feature was not updated: " + response);
	...
	@Test (description = "Create prod->dev->prod, update to dev->prod->prod (as a tree)")
	...
	public void test10() throws JSONException, IOException, InterruptedException{
	...
	@Test (description = "Create prod->prod->dev, update to dev->dev->prod (as a tree)")
	public void test11() throws JSONException, IOException, InterruptedException{
