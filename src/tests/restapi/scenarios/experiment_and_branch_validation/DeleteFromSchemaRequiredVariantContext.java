...
//delete from schema a required field used in variant
public class DeleteFromSchemaRequiredVariantContext
{
	...
	public void initExperiment() throws Exception
	{
		...
		String variantID = config.addVariant(experimentID, "variant1", "branch1", "experiments/variant1.txt", "context.device.datetime !== undefined");
