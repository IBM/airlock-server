...
public class DeleteFeatureReportedInOrderingRuleBranch {
	...
	public void addComponents() throws JSONException, IOException{
		...
		featureID2 = f.addFeatureToBranch(seasonID, branchID, json.toString(), featureID1, sessionToken);
		...
		featureID3 = f.addFeatureToBranch(seasonID, branchID, json.toString(), featureID1, sessionToken);
		...
		featureID4 = f.addFeatureToBranch(seasonID, branchID, json.toString(), featureID2, sessionToken);
		...
		featureID5 = f.addFeatureToBranch(seasonID, branchID, json.toString(), featureID2, sessionToken);
		...
		orderingRuleID1 = f.addFeatureToBranch(seasonID, branchID, jsonOR.toString(), featureID1, sessionToken);
		...
		jsonOR.put("configuration", configJson.toString());
		orderingRuleID2 = f.addFeatureToBranch(seasonID, branchID, jsonOR.toString(), featureID2, sessionToken);
	...
	public void deleteFeatureReportedInOrderingRule () throws Exception {
		int respCode = f.deleteFeatureFromBranch(featureID2, branchID, sessionToken);
	...
	public void removeFeatureFromORAndDeleteIt () throws Exception {
		...
		JSONObject jsonOR = new JSONObject(orderingRule);
		jsonOR.put("configuration", configJson.toString());
		String response = f.updateFeatureInBranch(seasonID, branchID, orderingRuleID1, jsonOR.toString(), sessionToken);
	...
	public void removeFeatureWithOrderingRule () throws Exception {
		int respCode = f.deleteFeatureFromBranch(featureID1,branchID,  sessionToken);
	...
	public void reAddComponents() throws JSONException, IOException{
		...
		mtxID = f.addFeatureToBranch(seasonID, branchID, mtxStr, featureID1, sessionToken);
		...
		featureID4 = f.addFeatureToBranch(seasonID, branchID, json.toString(), mtxID, sessionToken);
		Assert.assertFalse(featureID4.contains("error"), "Can't add feature  " + featureID4);

		json.put("name", RandomStringUtils.randomAlphabetic(5)+"XXXF55");
		featureID5 = f.addFeatureToBranch(seasonID, branchID, json.toString(), mtxID, sessionToken);
		Assert.assertFalse(featureID5.contains("error"), "Can't add feature  " + featureID5);
		...
		configJson.put(featureID4, "1.0");		
		jsonOR.put("configuration", configJson.toString());
		orderingRuleID2 = f.addFeatureToBranch(seasonID, branchID, jsonOR.toString(), mtxID, sessionToken);
		Assert.assertFalse(orderingRuleID2.contains("error"), "Can't add orderingRule  " + orderingRuleID2);
	...
	public void deleteMTXReportedInOrderingRule () throws Exception {
		int respCode = f.deleteFeatureFromBranch(mtxID, branchID, sessionToken);
	...
	public void reAddComponents2() throws JSONException, IOException{
		...
		orderingRuleMtxID1 = f.addFeatureToBranch(seasonID, branchID, orderingRuleMtx, featureID1, sessionToken);
		...
		orderingRuleID1 = f.addFeatureToBranch(seasonID, branchID, jsonOR.toString(), orderingRuleMtxID1, sessionToken);
		Assert.assertFalse(orderingRuleID1.contains("error"), "Can't add orderingRule  " + orderingRuleID1);

		orderingRuleMtxID2 = f.addFeatureToBranch(seasonID, branchID, orderingRuleMtx, mtxID, sessionToken);
		...
		configJson.put(featureID4, "1.0");		
		jsonOR.put("configuration", configJson.toString());
		orderingRuleID2 = f.addFeatureToBranch(seasonID, branchID, jsonOR.toString(), orderingRuleMtxID2, sessionToken);
		Assert.assertFalse(orderingRuleID2.contains("error"), "Can't add orderingRule  " + orderingRuleID2);
