...
public class DuplicateBranchWithOrderingRules2 {
    ...
    //F1 -> F2, MTXOR->OR1
    @Test(description ="F1 -> F2, MTXOR->OR1, checkout F1")
    public void addBranch1() throws Exception {
		...
		orderingRuleMtxID = f.addFeature(seasonID, orderingRuleMtx, featureID1, sessionToken);
		...
		orderingRuleID1 = f.addFeature(seasonID, jsonOR.toString(), orderingRuleMtxID, sessionToken);
		...
		jsonOR.put("configuration", configJson.toString());
		orderingRuleID2 = f.addFeatureToBranch(seasonID, branchID, jsonOR.toString(), orderingRuleMtxID, sessionToken);
    ...
    public void duplicateBranchInSameSeason() throws Exception{
        ...
        assertBranchDuplication(true,seasonID);
        //assert everything still works
        fJson.put("name", "F5");
        fJson.put("stage", "DEVELOPMENT");
    ...
    public void assertBranchDuplication (Boolean newIds, String season) throws Exception {
        ...
        JSONObject mx1 =  feature.getJSONArray("orderingRules").getJSONObject(0);
        
        assertItemDuplicated(feature,"CHECKED_OUT",featureID1,newIds,1,new String[]{"mx."+mx1.getString("uniqueId")},
                1,1,new String[]{"ns1.F2"}, null ,"ROOT");

       
        assertItemDuplicated(mx1,"CHECKED_OUT",orderingRuleMtxID,newIds,2,new String[]{"OR1.OR1","OR1.OR2"},
                2,0,new String[]{}, null ,null);

        JSONObject config = mx1.getJSONArray("orderingRules").getJSONObject(0);
        assertItemDuplicated(config,"CHECKED_OUT",orderingRuleID1,newIds,0,new String[]{},
                0,0,new String[]{}, null ,null);
       
        config = mx1.getJSONArray("orderingRules").getJSONObject(1);
        ...
        JSONObject featureInRuntime = branchWithFeatureRuntime.getJSONObject(0);

        mx1 =  feature.getJSONArray("orderingRules").getJSONObject(0);
        
        assertItemDuplicated(featureInRuntime,"CHECKED_OUT",featureID1,newIds,1,new String[]{"mx."+mx1.getString("uniqueId")},
                1,1,new String[]{"ns1.F2"}, null ,"ROOT");
        ...
        config = mx1.getJSONArray("orderingRules").getJSONObject(0);
        assertItemDuplicated(config,"CHECKED_OUT",orderingRuleID1,newIds,0,new String[]{},
                0,0,new String[]{}, null ,null);
