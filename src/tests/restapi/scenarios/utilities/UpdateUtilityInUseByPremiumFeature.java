...
public class UpdateUtilityInUseByPremiumFeature {
	...
	@Test(dependsOnMethods = "addPremiumFeature", description = "Change utility name when it is in use")
	public void updateUtility() throws JSONException{
		...
		response = u.updateUtility(utilityID, uJson, sessionToken);
