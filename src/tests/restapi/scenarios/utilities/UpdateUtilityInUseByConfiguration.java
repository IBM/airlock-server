...
public class UpdateUtilityInUseByConfiguration {
	...
	@Test(dependsOnMethods = "addConfigurationRule", description = "Update utility")
	public void updateUtility() throws JSONException{
		...
		uJson.put("utility", "function isTrue(){return false;}");
