...
public class InvalidUtility {
	...
	@Test(description = "Add utility with invalid javascript")
	public void addUtility() throws IOException, JSONException{
		...
		utilProps.setProperty("utility", "function isMetric(){context.userPreferences.metricSystem.spl()==1}");
