...
public class NonExistingUtilityInFeature {
	...
	@Test(description = "Add feature with rule using non-existing utility")
	public void addInvalidFeature() throws IOException, JSONException{
	...
	@Test(dependsOnMethods = "addInvalidFeature", description = "Add valid utility")
	...
	@Test(dependsOnMethods = "addFeature", description = "Update feature with rule using utility that doesn't exist")
