...
public class UpdateStreamUtility {
	...
	public void updateUtility() throws Exception{
			...
			json.put("utility", "function isFalse(){return false;}");
			u.updateUtility(utilityID, json, sessionToken);
			utility = u.getUtility(utilityID, sessionToken);
			json = new JSONObject(utility);
			Assert.assertTrue(json.getString("utility").equals("function isFalse(){return false;}"), "Failed to updated parameter \"utility\"."); 
